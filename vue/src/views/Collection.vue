<template>
  <div>
    ...
    <el-table :data="tableData" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="school" label="院校名称"></el-table-column>
    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%">
      <el-form label-width="100px" size="small">
        ...
        <el-form-item label="层级">
          <el-input v-model="form.classFlag" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    delBatch() {
      ...
      this.request.delete("/stdUser/del/batch", {data: ids}).then(res => {
        if(res.code === '200') {
    ...
    // 删除按钮
    handleDelete(id) {
      this.request.delete("/stdUser/" + id).then(res => {
        if(res.data) {
