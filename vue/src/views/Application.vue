<template>
  <div>
    ...
    <el-input style="width: 200px; margin-right: 5px" suffix-icon="el-icon-search" placeholder="请输入用户名称" v-model="name" ></el-input>
    ...
    <el-table-column prop="id" label="ID" min-width="40px"></el-table-column>
      <el-table-column prop="avatar" label="用户图标">
      ...
      <el-table-column prop="application4" label="院校志愿4"></el-table-column>
      <el-table-column prop="application5" label="院校志愿5"></el-table-column>
    ...
    <el-dialog title="志愿信息" :visible.sync="dialogFormVisible" width="65%">
      <el-form label-width="150px" size="small">
        ...
        <el-form-item label="院校志愿 Ⅰ">
          <el-input v-model="form.application1" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="院校志愿 Ⅱ">
          <el-input v-model="form.application2" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="院校志愿 Ⅲ">
          <el-input v-model="form.application3" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="院校志愿 Ⅳ">
          <el-input v-model="form.application4" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="院校志愿 Ⅴ">
          <el-input v-model="form.application5" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    delBatch() {
      ...
      this.request.delete("/application/del/batch", {data: ids}).then(res => {
        if(res.code === '200') {
