<template>
  <div>
    ...
    <el-table-column prop="name" label="学校名称"></el-table-column>
      <el-table-column prop="description" label="院校详细" :formatter="stateFormat"></el-table-column>
      <el-table-column prop="link" label="招生网址"></el-table-column>
